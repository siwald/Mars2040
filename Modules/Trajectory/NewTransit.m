function [ spacecraft, Sci_Time ] = NewTransit( Cur_Arch, spacecraft, type, Sci_Time)
...
switch Cur_Trajectory
    case TrajectoryType.Hohmann
        ...
        Trans_Eng = Propellant_Mass(Cur_Arch.Propulsion,Trans_Eng,Hohm_Chart('EML1','TMI'),spacecraft.Mass);
...
if type = 'Human'
    Sci_Time = Sci_Time * Rotation_Period ... now it's in CM-days/Rotation Period
