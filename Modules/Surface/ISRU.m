...
Required_Daily_Ox_Mars = Results.ISRU.Oxidizer_Output / (Time_Between_Missions * 30);
...
%% BS for other ISRU needs
ISRU_Power = ISRU_Power / Results.ISRU.Oxidizer_Output * ...
    nansum([Results.ISRU.Oxidizer_Output, Results.ISRU.Fuel_Output, ....
    ECLSS_Requirements.Water, ECLSS_Requirements.Oxygen, ...
    mECLSS_Requirements.Nitrogen, ECLSS_Requirements.CO2]);

ISRU_Volume = ISRU_Volume / Results.ISRU.Oxidizer_Output * ...
    nansum([Results.ISRU.Oxidizer_Output, Results.ISRU.Fuel_Output, ....
    ECLSS_Requirements.Water, ECLSS_Requirements.Oxygen, ...
    mECLSS_Requirements.Nitrogen, ECLSS_Requirements.CO2]);

ISRU_Mass = ISRU_Mass / Results.ISRU.Oxidizer_Output * ...
    nansum([Results.ISRU.Oxidizer_Output, Results.ISRU.Fuel_Output, ....
    ECLSS_Requirements.Water, ECLSS_Requirements.Oxygen, ...
    mECLSS_Requirements.Nitrogen, ECLSS_Requirements.CO2]);
