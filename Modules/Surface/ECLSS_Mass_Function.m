...
ECLSS.Equipment_Volume.Overall = ECLSS.Equipment_Volume.OGA + ECLSS.Equipment_Volume.CDRA + ECLSS.Equipment_Volume.CCAA + ECLSS.Equipment_Volume.UPA + ECLSS.Equipment_Volume.WPA + ECLSS.Equipment_Volume.CRA + ECLSS.Equipment_Volume.CO2_Injector + ECLSS.Equipment_Volume.BPS;
ECLSS.Equipment_Power.Overall = ECLSS.Equipment_Power.OGA + ECLSS.Equipment_Power.CDRA + ECLSS.Equipment_Power.CCAA + ECLSS.Equipment_Power.UPA + ECLSS.Equipment_Power.WPA + ECLSS.Equipment_Power.CRA + ECLSS.Equipment_Power.CO2_Injector;
