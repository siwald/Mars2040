...
% Morph = MarsArchitecture.Enumerate({[TransitFuel.LUNAR_LH2,TransitFuel.LUNAR_O2],[TransitFuel.EARTH_LH2,TransitFuel.EARTH_O2]}, ...
%          {[ReturnFuel.EARTH_LH2, ReturnFuel.EARTH_O2],[ReturnFuel.MARS_LH2,ReturnFuel.MARS_O2],[ReturnFuel.EARTH_LH2,ReturnFuel.MARS_O2]});
